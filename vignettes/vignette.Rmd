...
Core operations on structural and positional attributes are implemented in "pure R", but the CWB can be downloaded and stored within the package.
...
This is a rudimentary check (using low-level RcppCWB functions) whether to corpus can be used. How often does the token "pride" occurr?
...
... we have a look at the token strem ... 
